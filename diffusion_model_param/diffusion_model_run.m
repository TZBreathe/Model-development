...
function [voltOut Vdiff Vbv]=diffusion_model_run(k,currData,timeData,socData,tempData,OcvLuts)
%params
...
v_Out(timestep)=IR0+Vbv(timestep)+Vdiff(timestep)+OCVcell(timestep)+U_hyst;
