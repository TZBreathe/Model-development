...
%%
for i=1:10
lincc_25{i}=[currentSeries{i} voltageSeries{i} socRefSeries{i}];
end
save 'lincc_25.mat' lincc_25;

for i=1:4
lincc_35{i}=[currentSeries{i+10} voltageSeries{i+10} socRefSeries{i+10}];
end
save 'lincc_35.mat' lincc_35;

for i=1:4
lincc_45{i}=[currentSeries{i+14} voltageSeries{i+14} socRefSeries{i+14}];
end
